...
contact=f'''<div class="wrap contact-content"><div class="contact-grid"><div class="contact-information"><section><span class="contact-number">EMAIL</span><h3>Email addresses</h3><div class="contact-emails"><a class="email" href="mailto:jf.blazquizpulido@imtlucca.it">jf.blazquizpulido@imtlucca.it ↗</a><a class="email" href="mailto:juan.blazquiz@uv.es">juan.blazquiz@uv.es ↗</a></div></section><section><span class="contact-number">ADDRESS / SPAIN</span><h3>Universitat de València</h3><address>Departament d’Anàlisi Econòmica<br>Av. dels Tarongers, s/n<br>46022 Valencia, Spain</address></section></div><figure class="contact-photo"><img src="{escape(assets['contact_photo'],quote=True)}" alt="Hand sculpture on the University of Alicante campus" width="620" height="368" loading="lazy"></figure></div><section class="contact-socials"><h2>Find me online</h2>{profiles(icons=True)}</section></div>'''
document('contact','Contact',contact,'Valencia, Spain')
